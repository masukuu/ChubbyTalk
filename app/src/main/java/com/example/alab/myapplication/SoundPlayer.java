    ...
    public static void playSound(int btnId, Context context) {
        ...
        switch (btnId) {
            ...
            case R.id.btn_cz_24:
                ...
                break;
            case R.id.btn_cn_25:
                mp = MediaPlayer.create(context, R.raw.cn_25);
                break;
//            case R.id.btn_k_25:
//                mp = MediaPlayer.create(context, R.raw.k_25);
//                break;
            case R.id.btn_hk_25:
                mp = MediaPlayer.create(context, R.raw.hk_25);
                break;
//            case R.id.btn_tw_25:
//                mp = MediaPlayer.create(context, R.raw.tw_25);
//                break;
//            case R.id.btn_cz_25:
//                mp = MediaPlayer.create(context, R.raw.cz_25);
//                break;

            case R.id.btn_cn_26:
                mp = MediaPlayer.create(context, R.raw.cn_26);
                break;
            case R.id.btn_k_26:
                mp = MediaPlayer.create(context, R.raw.k_26);
                break;
            case R.id.btn_hk_26:
                mp = MediaPlayer.create(context, R.raw.hk_26);
                break;
            case R.id.btn_tw_26:
                mp = MediaPlayer.create(context, R.raw.tw_26);
                break;
//            case R.id.btn_cz_26:
//                mp = MediaPlayer.create(context, R.raw.cz_26);
//                break;
